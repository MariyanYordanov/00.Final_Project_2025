    ...
    public class AppDbContext : IdentityDbContext<User, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Relationship>(entity =>
            {
                ...
                entity.HasCheckConstraint("CK_Relationship_NoSelfReference",
            ...
            modelBuilder.Entity<Comment>(entity =>
            {
                ...
                // Ensure comment belongs to either photo or story, not both
                entity.HasCheckConstraint("CK_Comment_PhotoOrStory",
                    "([PhotoId] IS NOT NULL AND [StoryId] IS NULL) OR ([PhotoId] IS NULL AND [StoryId] IS NOT NULL)");
            });
