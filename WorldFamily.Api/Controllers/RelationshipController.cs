...
namespace WorldFamily.Api.Controllers
{
    ...
    public class RelationshipController : ControllerBase
    {
        ...
        // GET: api/relationship/member/{memberId}
        ...
        // GET: api/relationship/family/{familyId}
        ...
        // GET: api/relationship/member/{memberId}/tree
        ...
        public async Task<ActionResult<RelationshipDto>> CreateRelationship([FromBody] CreateRelationshipDto dto)
        {
            try
            {
                ...
                // Check if user owns the family of both members
        ...
        // GET: api/relationship/check/{primaryMemberId}/{relatedMemberId}
